...
$insert_tmp=mysqli_query($con, "INSERT INTO tmp (id_producto,cantidad_tmp,precio_tmp,session_id) VALUES ('$id','$cantidad','$precio_venta','$session_id')");
    ...
    $update=mysqli_query($con, "UPDATE products SET cant='".$stock."' WHERE id_producto='".$id."'");
}
...
$id_tmp=intval($_GET['id']);	
    ...
    $update=mysqli_query($con, "UPDATE products SET cant=cant+'".$can."' WHERE id_producto='".$geTpro."'");
