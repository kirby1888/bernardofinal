...
<?php
	...
	if (empty($_POST['nombres'])) {
		...
		$descripcion=mysqli_real_escape_string($mysqli,(strip_tags($_POST["descripcions"],ENT_QUOTES)));
			  ...
			  $objeto="tbl_tipvacunas";
                     $us="probando";
                    $accion="UPDATE";
         
            
		$sql="UPDATE tbl_tipvacunas SET nombre='".$nombre."', descripcion='".$descripcion."' WHERE id_tipovacuna='".$id_tipo."'";
		$query_update = mysqli_query($mysqli,$sql);
		 $id= 1;
			...
			if ($query_update){
				...
				$messages[] = "La vacuna ha sido actualizado satisfactoriamente.";
			} else{
