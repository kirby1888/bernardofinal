	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-remove'></i> ¿Seguro que deséa eliminar este Control de Vacunas?</h4>
		  </div>
		  ...
		  <div class="modal-footer">
			...
			<button type="submit" class="btn btn-danger" id="actualizar_datos3">Eliminar Control</button>
		  </div>
		  </form>
		</div>
	  </div>
