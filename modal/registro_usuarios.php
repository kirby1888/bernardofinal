			  ...
			  <div class="form-group">
			   <label for="usuario" class="col-sm-3 control-label">Usuario</label>
				<div class="col-sm-8">
			  	 <div class="input-group">
			  	  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>			  	  
				  <input  type="text" class="form-control" id="usuario" name="usuario" placeholder="Usuario" pattern="[a-zA-Z0-9]{2,64}" title="Usuario" style="text-transform: uppercase;" onkeypress="soloLetras(event)" onkeyup="noespacios();" pattern="|^[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]*$|"  onPaste="return false;"  maxlength="15" autocomplete="off" required>
			  ...
			  <div class="form-group">
				<label for="correo_electronico" class="col-sm-3 control-label">Correo Electronico</label>
				 <div class="col-sm-8">
				    ...
				    <input title="E-mail" type="email" class="form-control" id="correo_electronico" name="correo_electronico" onkeyup="return nospaces1();"  placeholder="Correo Electronico" maxlength="80" onPaste="return false;"  autocomplete="off" >
					</div>
				  </div>
				</div>	
          ...
          return false();
			  ...
			  <div class="form-group">
				<label for="contrasena" class="col-sm-3 control-label">Contraseña</label>
				 <div class="col-sm-8">
				   ...
				   <input  type="password" class="form-control" id="contrasena" name="contrasena" placeholder="Contraseña" pattern=".{6,}" title="Contraseña ( min . 6 caracteres)" maxlength="20" onPaste="return false;"  required onkeyup="return noespacios1();">
			  ...
			  <label for="contrasena" class="col-sm-3 control-label">Confirmar Contraseña</label>
			   <div class="col-sm-8">
		  		<div class="input-group">
			  	<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
				<input title="Confirmacion de Contraseña" type= "password" name="contrasena2"  id="contrasena2" class="form-control" autocomplete="off" autofocus="on" onkeyup="return nospaces2()" placeholder="Confirmar Contraseña" maxlength="20" onPaste="return false;"  required >
