	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-remove'></i> ¿Seguro que deséa eliminar esta Vacuna?</h4>
		  </div>
		  <div class="modal-body">
			...
			<div id="resultados_ajax3"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" id="user_id_mod" name="user_id_mod">
				</div>
			  </div>
	
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" onClick="location.reload();" data-dismiss="modal">Cerrar</button>
			<button type="submit" class="btn btn-danger" id="actualizar_datos3">Eliminar Vacuna</button>
		  </div>
		  </form>
		</div>
	  </div>
