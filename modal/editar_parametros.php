		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
            ...
            <label for="parametro" class="col-sm-3 control-label">Parametro:</label>
				<div class="col-sm-8">
				  <input title="Nombre del Parametro" type="text" class="form-control" id="parametros" name="parametros" placeholder="parametro" style="text-transform: uppercase;" onkeypress="return soloLetras(event)"  maxlength="50"  onPaste="return false;"  onkeyup="return unespacio()" required> 
        ...
        if(letras.indexOf(tecla)==-1 && !tecla_especial){
            return false;
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="valors" name="valors" placeholder="valor" maxlength="150" required title="Valor del Parametro" onkeyup="return noespacios()">
				</div>
			  </div>
