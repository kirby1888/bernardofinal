	 ...
	 <div class="container">
		...
		<div class="panel-heading">
		    ...
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus" ></span> Nuevo Proveedor</button>
			</div>
			<?php } ?>
		...
		<form>
				...
				<?php
	require 'modal/editar_proveedor.php';
require 'modal/registro_proveedor.php';
require 'modal/eliminar_proveedor.php';
...
$( "#editar_password" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	  ...
	  function obtener_datos(hola,RTN,nom_empresa,representante,num_tel1,num_tel2,tipo,cor_empresa){
		
			$("#hola").val(hola);	
			$("#RTN").val(RTN);
	        $("#nom_empresa").val(nom_empresa);
	        $("#representante").val(representante);
			$("#num_tel1").val(num_tel1);
	 		$("#num_tel2").val(num_tel2);
		    $("#tipo").val(tipo);
		    $("#cor_empresa").val(cor_empresa);
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/nuevo_proveedoressss.php",
			data: parametros,
			 beforeSend: function(objeto){
...
function reportePDF(){
	var desde = $('#bd-desde').val();
	var hasta = $('#bd-hasta').val();
	window.open('reporte/proveedores.php?desde='+desde+'&hasta='+hasta);
}
