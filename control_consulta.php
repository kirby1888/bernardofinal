...
$row = $result->fetch_assoc();
		...
		$objeto="pantalla consulta2";
		$accion="INGRESO";
		$descripcion="ingreso a pantalla consultas";
	...
	<div class="contact-top">
		...
		<div class="panel-heading">
			...
			<?php
			    ...
			    include("modal/editar_control_consulta.php");
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
                ...
                include("modal/eliminar_control_consulta.php");
...
$( "#editar_password" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/eliminar_control_consulta.php",
			data: parametros,
...
$( "#editar_usuario" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/editar_control_consulta.php",
			data: parametros,
			 beforeSend: function(objeto){
  ...
  event.preventDefault();
		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'ajax/buscar_control_consulta.php',
				 beforeSend: function(objeto){
		...
		function obtener_datos(id,nom,motivo,sintomas,tratamientos,dietas){ 				
			$("#mod_id").val(id);
			$("#nombres").val(nom);
            $("#motivos").val(motivo);
            $("#sintomas1").val(sintomas);
            $("#tratamientos").val(tratamientos);
            $("#dietas").val(dietas);
