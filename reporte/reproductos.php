...
$pdf->Cell(25, 8, 'Fecha Registro', 0);

$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysqli_query($mysqli,"SELECT id_producto, codigo_producto, nombre_producto, precio_producto, cant, date_added, tipo, status_producto FROM products WHERE date_added BETWEEN '$desde' AND '$hasta' order by date_added ");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(20, 8, $productos2['precio_producto'], 0);	
...
$pdf->Output('reporte de productos.pdf','D');
?>