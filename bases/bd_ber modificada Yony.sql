...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2017 a las 02:11:28
...
(24, 'anaka@hot.com', '5', '0000-00-00 00:00:00'),
(25, 'GENIAL', '5', '0000-00-00 00:00:00');
...
(1, 'JUAN PABLO', 22345676, 98675875, 'Los Robles quin', '22345674', 'independiente', 'PEDRO', 'juan@yahoo.com', '2017-09-18 22:14:24', '2017-09-18 22:14:24');
...
INSERT INTO `tbl_tiposervicios` (`id_tipo`, `nombre`, `descripcion`, `precio`, `fecha_registro`) VALUES
...
--
ALTER TABLE `tbl_bitacoras`
  MODIFY `id_bitacora` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
--
...
--
ALTER TABLE `tbl_parametros`
  MODIFY `id_parametro` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `tbl_usuario`
  MODIFY `id_usuario` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
