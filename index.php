...
<html>
	...
	<body >
	 <img ="C:\xampp\htdocs\login\images\giphy.gif">
		
		<div class="container">    
			<div class="row">
				<div id="loginbox"  class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" style="margin-top: 60px"> 
				    <nav class="recupera">
				        <ul style="float:right; " class="nav">
				           <li><a href="#"> Recuperar Password</a>
				             <ul>
				                <li><a href="recupera.php"> Recuperar por correo</a></li> 
							...
							<form id="loginform" class="form-horizontal" role="form"  autocomplete="off">
					            <center>
					                <div class="form-group">
										<img src="images/pro.png" alt="image" width="130" height="130px">
									</div>
					            </center>
	...
	$(document).on('submit', '#loginform', function(event) {
		...
		$.ajax({
			...
			success:function(data){
				...
				if(data=="ok"){
					toastr.success("Bienvenido al Sistema de Veterinaria");
					setTimeout(function(){
